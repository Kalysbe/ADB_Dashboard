                                    ...
                                    <div className="p-4 partial-block">
                                        <div className="row">
                                            <div className="form-group col-md-12">
                                                <FormControl>
                                                    <FormLabel id="demo-radio-buttons-group-label">Тип документа</FormLabel>
                                                    <RadioGroup
                                                        ...
                                                        sx={{ display: 'flex' }}
                                                    >
                                                        <FormControlLabel value="Initial" control={<Radio />} label=" Первоначальный" />
                                                        <FormControlLabel value="Correction" control={<Radio />} label="Уточненный" />
                                                        <FormControlLabel value="Liquadation" control={<Radio />} label="Ликвидационный" />
                                                    </RadioGroup>
                                                </FormControl>
                                            </div>
                                        ...
                                        <input type="hidden" value={formData["PeriodDate"]} onChange={handleChange} id="PeriodDate" /> */}
                                            ...
                                            <div className="col-md-12 pl-0">
                                                <div className="d-flex col-12 pl-0 mt-4">
                                                    ...
                                                    <FormControl>
                                                        <RadioGroup
                                                            ...
                                                            row
                                                        >
                                                            <FormControlLabel value="1" control={<Radio />} label="МСФО" />
                                                            <FormControlLabel value="2" control={<Radio />} label="МСФО для малого, среднего предпринимательства" />
                                                            <FormControlLabel value="3" control={<Radio />} label="Упрощенный учет" />
                                                        </RadioGroup>
                                                    </FormControl>
                                                </div>
                                                <div className="d-flex col-12 pl-0 mt-4">
                                                ...
                                                <div className="d-flex col-12 pl-0 mt-4">
                                                    ...
                                                    <FormControl>
                                                        <RadioGroup
                                                            ...
                                                            row
                                                        >
                                                            <FormControlLabel value="1" control={<Radio />} label=" Метод начисления" />
                                                            <FormControlLabel value="2" control={<Radio />} label=" Кассовый метод" />
                                                        </RadioGroup>
                                                    </FormControl>
                                                </div>
                                                ...
                                                <div className="col-md-12 mt-5 md-5 ">
                                                    ...
                                                    <div className="d-flex  align-items-center align-content-start col-md-12 pl-2">
                                                            ...
                                                            <MDBox sx={{ display: 'flex' }}>
                                                                ...
                                                                <FormGroup>
                                                                    <FormControlLabel
                                                                        ...
                                                                        onChange={handleChange}
                                                                        control={<Checkbox />}
                                                                        label=" Приложение 5 (FORM STI -102-005)" />
                                                                    <FormControlLabel
                                                                        name="STI101X6"
                                                                        checked={formData["STI101X6"]}
                                                                        onChange={handleChange}
                                                                        control={<Checkbox />}
                                                                        label=" Приложение 6 (FORM (STI -102-006)" />
                                                                    <FormControlLabel
                                                                        name="STI101X7"
                                                                        checked={formData["STI101X7"]}
                                                                        onChange={handleChange}
                                                                        control={<Checkbox />}
                                                                        label="Приложение 7 (FORM STI -102-007)" />
                                                                    <FormControlLabel
                                                                        name="STI101X8"
