                    ...
                    <div className="main-content-wrap sidenav-open d-flex flex-column pb-5">
                        <div className="main-content">
                            ...
                            <div>
                                ...
                                >
                                    <input type="hidden" onChange={handleChange} value={data["Specified"]} id="Specified" />
                                    ...
                                    <div className="my-4 p-4 rounded-20px bg-white">
                                        ...
                                        <div className="my-4 p-2 pt-4 rounded-20px bg-white">
                                            <input type="hidden" value={data["Year"]} onChange={handleChange} id="Year" />

                                            <input
                                                type="hidden"
                                                value={data["EndDateLiquidation"]}
                                                onChange={handleChange}
                                                id="EndDateLiquidation"
                                            />
                                            <input type="hidden" value={data["YearQuarter"]} onChange={handleChange} id="YearQuarter" />

                                            <input type="hidden" value={data["PeriodDate"]} onChange={handleChange} id="PeriodDate" />
